...
--
-- Host: localhost:3306
-- Generation Time: Jun 07, 2019 at 07:29 PM
...
ALTER TABLE `sports_teams`
  ADD PRIMARY KEY (`id`),
  ADD KEY `league_k` (`league`),
  ADD KEY `section_k` (`section`),
  ADD KEY `division_k` (`division`),
  ADD KEY `sport_k` (`sport`),
  ADD KEY `city_k` (`city`),
  ADD KEY `province_k` (`province`),
  ADD KEY `country_k` (`country`);
...
--
ALTER TABLE `sports_teams`
  ADD CONSTRAINT `city_k` FOREIGN KEY (`city`) REFERENCES `cities` (`id`),
  ADD CONSTRAINT `country_k` FOREIGN KEY (`country`) REFERENCES `countries` (`id`),
  ADD CONSTRAINT `division_k` FOREIGN KEY (`division`) REFERENCES `sports_divisions` (`id`),
  ADD CONSTRAINT `league_k` FOREIGN KEY (`league`) REFERENCES `sports_leagues` (`id`),
  ADD CONSTRAINT `province_k` FOREIGN KEY (`province`) REFERENCES `provinces` (`id`),
  ADD CONSTRAINT `section_k` FOREIGN KEY (`section`) REFERENCES `sports_sections` (`id`),
  ADD CONSTRAINT `sport_k` FOREIGN KEY (`sport`) REFERENCES `sports_types` (`id`);
COMMIT;
